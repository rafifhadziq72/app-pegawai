...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            <h1 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Form Catat Absensi</h1>
            ...
            <form action="{{ route('attendances.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="time" id="waktu_masuk" name="waktu_masuk" value="{{ now()->format('H:i') }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                    </div>
